...
from senda.ml_logic.data import get_data_with_cache, clean_data, load_data_to_bq
from senda.ml_logic.model import initialize_model, compile_model, train_model, evaluate_model
from senda.ml_logic.preprocessor import preprocess_features
...
def preprocess() -> None:
    ...
    data_query_cache_path = Path(LOCAL_DATA_PATH).joinpath("raw", f"{DATA_SIZE}.csv")
